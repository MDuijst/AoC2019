...
public class Day03Test {
    ...
    void testExampleOne() {
        String input = "R8,U5,L5,D3\n" +
                "U7,R6,D4,L4";
        separateWires(input);
        assertEquals(6, getShortestDistance(getMatchingCoordinates(readInstruction(wireAInstructions),readInstruction(wireBInstructions))));
    }
    @Test
    void testExampleTwo() {
        ...
        separateWires(input);
        assertEquals(159, getShortestDistance(getMatchingCoordinates(readInstruction(wireAInstructions),readInstruction(wireBInstructions))));
    }
    @Test
    void testExampleThree() {
        ...
        separateWires(input);
        assertEquals(135, getShortestDistance(getMatchingCoordinates(readInstruction(wireAInstructions),readInstruction(wireBInstructions))));
    }
    @Test
    void testExampleFour() {
        String input = "R75,D30,R83,U83,L12,D49,R71,U7,L72\n" +
                "U62,R66,U55,R34,D71,R55,D58,R83";
        separateWires(input);
        assertEquals(610, getShortestDistanceInNoOfSteps(readInstruction(wireAInstructions),readInstruction(wireBInstructions)));
    }
    @Test
    ...
    void puzzle() {
        ...
        separateWires(input);
        System.out.println("Day01(a): " + getShortestDistance(getMatchingCoordinates(readInstruction(wireAInstructions),readInstruction(wireBInstructions))));
        System.out.println("Day01(b): " + getShortestDistanceInNoOfSteps(readInstruction(wireAInstructions),readInstruction(wireBInstructions)));
    }
